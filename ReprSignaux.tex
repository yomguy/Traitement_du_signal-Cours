...
Le principe du spectrogramme est de « découper » le son en trames. Pour chacune de ces trames on calcule une transformée de Fourier comme le schématise la figure \ref{tfct}. Ce spectre est alors représenté à un temps correspondant à celui du centre de la fenêtre, sous forme d'un code de couleur.
